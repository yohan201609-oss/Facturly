...
const profileSchema = z.object({
  ...
  invoicePrefix: z.string().max(10, 'Máximo 10 caracteres').optional(),
...
export default function Settings() {
  ...
  useEffect(() => {
    if (user) {
      // Solo resetear con los campos que necesitamos para evitar enviar basura al backend
      const formData = {
  ...
  const mutation = useMutation({
    mutationFn: async (data) => {
      console.log('API PUT a /users/profile con:', data);
    ...
    onError: (error) => {
      ...
      toast.error('Error al guardar: ' + (error.response?.data?.message || 'Servidor no responde'));
    },
  });
  ...
  return (
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <form onSubmit={handleSubmit(onFormSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="col-span-2">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none text-sm dark:text-gray-200" 
                      placeholder="Nombre de tu empresa"
                    />
                    {errors.companyName && <p className="text-red-500 text-xs mt-1 font-bold">{errors.companyName.message}</p>}
                  </div>
                  <div>
                ...
                <div className="pt-4 flex justify-end">
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-8 py-3 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 dark:shadow-none disabled:opacity-50 active:scale-95"
                  >
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">Reduce el cansancio visual en entornos oscuros.</p>
                    </div>
                  </div>
                  <button
                    type="button"
          ...
          {/* Lateral */}
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-blue-600 to-blue-800 dark:from-blue-700 dark:to-blue-900 rounded-2xl shadow-lg p-6 text-white border border-blue-500 dark:border-blue-800">
